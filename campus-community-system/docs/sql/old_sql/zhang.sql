...
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='收藏表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `leaderboard` VALUES (1,'热门帖子榜','根据点赞、评论、收藏综合排名的热门帖子','post','all',1,1,10,'2025-11-05 06:02:11','2025-11-05 06:02:11'),(2,'活跃用户榜','根据发帖和评论活跃度排名的用户','user','monthly',1,2,10,'2025-11-05 06:02:11','2025-11-05 06:02:11'),(3,'收藏排行榜','根据收藏数量排名的帖子','favorite','weekly',1,3,10,'2025-11-05 06:02:11','2025-11-05 06:02:11'),(4,'点赞排行榜','根据点赞数量排名的帖子','like','weekly',1,4,10,'2025-11-05 06:02:11','2025-11-05 06:02:11'),(5,'月度收藏榜','月度收藏数量排名','favorite','monthly',1,5,10,'2025-11-05 06:02:11','2025-11-05 06:02:11'),(6,'月度点赞榜','月度点赞数量排名','like','monthly',1,6,10,'2025-11-05 06:02:11','2025-11-05 06:02:11');
...
) ENGINE=InnoDB AUTO_INCREMENT=86 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='点赞记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='私信表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `message` VALUES (1,2,1,'2_1','你好，关于考研数学的问题想请教一下',0,'2025-03-01 12:00:00'),(2,1,2,'2_1','好的，有什么问题尽管问',0,'2025-03-01 12:05:00'),(3,3,4,'3_4','保研面试经验很实用，谢谢分享',0,'2025-04-01 13:00:00'),(4,4,3,'3_4','不客气，希望能帮到你',0,'2025-04-01 13:10:00'),(5,5,6,'5_6','保研材料准备有什么建议吗？',0,'2025-04-08 14:00:00'),(6,6,5,'5_6','建议提前准备，材料要齐全',0,'2025-04-08 14:15:00'),(7,13,12,'12_13','我有需要，请问有哪些书呀？',NULL,'2025-11-01 12:21:41'),(8,12,11,'11_12','您好，同道中人，加个好友交流下？',NULL,'2025-11-01 16:24:21'),(9,13,12,'12_13','您好，我需要，请问都有哪些书呀？',NULL,'2025-11-01 16:25:27'),(10,12,11,'11_12','你好兄弟，加个联系方式一起玩呀',NULL,'2025-11-01 17:12:39'),(11,13,12,'12_13','你好我需要，请问都包含哪些课本呀？',NULL,'2025-11-01 18:29:53'),(12,12,13,'12_13','有离散数学、计算机组成原理、数据结构、数字逻辑，但红课课本已经全部出掉了，你看你需要哪些？',1,'2025-11-01 18:48:17'),(13,13,12,'12_13','嗷嗷好的，正好都需要，价格怎么说？',1,'2025-11-01 18:53:35'),(14,12,13,'12_13','一本10块可以接受吗？',1,'2025-11-01 18:54:15'),(15,12,13,'12_13','或者便宜点，8元也行',1,'2025-11-01 19:06:38'),(16,13,3,'3_13','我需要，请问多少钱出？',0,'2025-11-03 10:48:54');
...
CREATE TABLE `post` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='帖子表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `post` VALUES (1,1,1,'2026考研数学一难度会如何？','感觉今年的数学特别难，不知道明年会不会简单一点，大家有什么看法？',0,0,121,4,10,8,0,'2025-03-01 02:00:00'),(2,2,1,'求一份靠谱的政治考研复习资料','市面上的资料太多了，求推荐！',0,0,85,0,1,5,0,'2025-03-02 03:00:00'),(3,3,1,'英语一阅读理解技巧分享','经过一年的复习，总结了一些阅读理解的技巧，希望对大家有帮助。',0,0,200,0,10,12,0,'2025-03-05 06:00:00'),(4,4,2,'计算机专业保研夏令营面试经验','分享一下面试中被问到的问题，希望能帮助到大家。',0,0,150,4,10,9,0,'2025-04-01 04:00:00'),(5,5,2,'保研边缘人，如何最大化自己的机会？','成绩在保研边缘，有点焦虑，求技巧分享。',0,0,95,0,1,7,0,'2025-04-05 05:00:00'),(6,6,2,'保研材料准备清单','整理了一份保研材料准备清单，需要的同学可以看看。',0,0,180,0,10,15,0,'2025-04-08 07:00:00'),(7,7,3,'\"挑战杯\"竞赛组队，来一个会做PPT的大佬','项目技术人员已齐，缺一个审美在线、会做商业计划书和PPT的大佬。',0,0,61,0,1,3,0,'2025-05-10 06:00:00'),(8,8,3,'数学建模美赛要开始了，你准备好了吗？','美赛要肝三天三夜，大家开始找队友、刷真题了吗？',0,0,111,0,1,6,0,'2025-05-12 07:00:00'),(9,9,3,'ACM竞赛刷题经验分享','从零基础到区域赛银牌，分享一下我的刷题经验。',0,0,252,7,9,10,0,'2025-05-15 08:00:00'),(10,1,4,'【出】九成新Kindle Paperwhite 4','买了没怎么用，价格可小刀，走闲鱼。',0,0,46,0,1,2,0,'2025-06-01 08:00:00'),(11,2,4,'【收】一辆二手自行车，代步用','新校区太大，没车寸步难行，求一辆便宜皮实的二手自行车。',0,0,30,0,1,1,0,'2025-06-03 09:00:00'),(12,3,4,'【出】考研英语真题集','2020-2024年真题，有详细解析，几乎全新。',0,0,28,0,2,1,0,'2025-06-05 10:00:00'),(13,4,5,'学校东门新开的那家麻辣烫味道怎么样？','路过好几次了，有没有去吃过的同学来说说味道如何？',0,0,85,3,1,4,0,'2025-07-15 10:00:00'),(14,5,5,'有人知道图书馆预约系统又崩了吗？','早上起来想约个座位，结果一直转圈圈，是我的问题还是系统的问题？',0,0,67,1,2,2,0,'2025-07-20 11:00:00'),(15,6,5,'期末考试复习计划分享','还有一个月就期末考试了，分享一下我的复习计划，大家一起加油！',0,0,180,7,6,6,0,'2025-07-25 12:00:00'),(16,11,5,'手游同好','这个游戏好冷门啊，有没有一起玩的',0,0,26,1,1,1,0,'2025-10-29 07:48:30'),(17,12,4,'南12出书，有意者带价来','本人坐标CES大三，宿舍快堆不下了，出售大二的所有专业课本，有意者私聊！',0,0,26,0,2,2,0,'2025-11-01 12:20:05');
...
-- Dump completed on 2025-11-05 22:34:14
